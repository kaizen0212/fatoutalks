...
const Hero = () => {
  return (
    <header className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary via-primary/95 to-primary/90">
      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative animate-slide-in">
            ...
            <img
              src={coachImage}
              alt="Fatou, coach professionnelle en prise de parole et expression scénique, lors d'une session de coaching"
